...
\begin{itemize}
	...
	\item la \textbf{cinematica}: branca della meccanica che si occupa della descrizione del moto di un corpo indipendentemente dalle cause che lo determinano.
\end{itemize}
...
\begin{figure}[htpb!]
	...
	\draw    (15,110.5) .. controls (206,1.5) and (285,10.5) .. (335,156.5) ;
	...
	%Curve Lines [id:da7004914858661597] 
	\draw    (467.56,156.5) .. controls (409,214.5) and (353,203.5) .. (335,156.5) ;
	...
	% Text Node
	\draw (252.5,19.33) node    {$\vec{u}_{t}( t_{1})$};
	% Text Node
	\draw (346,70.83) node    {$\vec{u}_{t}( t_{1} +dt)$};
	% Text Node
	\draw (462,102.83) node    {$ds\ =\rho \ d\vartheta $};
