...
\begin{figure}[ht]
	...
	% Text Node
	\draw (143,82) node    {$E_{p,\text{ efficace}}$};
	% Text Node
	\draw (495,184) node    {$r$};
	% Text Node
...
\begin{figure}[htpb]
	...
	% Text Node
	\draw (145,44) node    {$E_{p,\text{ efficace}}$};
	% Text Node
	\draw (495,144) node    {$r$};
	% Text Node
...
\begin{figure}[htpb]
	...
	% Text Node
	\draw (90.67,257.67) node    {$E_{\text{mecc},\ min}$};
	% Text Node
	\draw (86.17,215.67) node    {$E_{\text{mecc}}< 0$};
	% Text Node
	\draw (86.17,159.17) node    {$E_{\text{mecc}}=0$};
	% Text Node
	\draw (86.17,116.17) node    {$E_{\text{mecc}} >0$};
